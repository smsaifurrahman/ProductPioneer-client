...
//  };
  ...
  return (
   <div>
    <h2 className='text-3xl text-center font-bold my-6'> Add a new Product Here </h2>
        <div className=" md:w-3/4 mx-auto p-4 bg-white border rounded 
    shadow-md">
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-1 md:grid-cols-2">
        ...
        <div>
          <label className="block text-gray-700">Product Owner Name:</label>
          <input
